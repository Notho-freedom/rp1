...
class hanta(tk.Tk):
    ...
    def __init__(self, root):
        ...
        tb_F.place(x=350,y=95,width=670,height=535) 
        ...
        Button(dt_F, text="Supprimer +" , bg="red",fg="white",command=supp_comp).grid(row=1,column=5,padx=5,pady=10)  
        #frame droite
        ...
        Button(f_g, text="Actualiser" , bg="black",fg="white",command=D_T).place(x=200,y=640)  
