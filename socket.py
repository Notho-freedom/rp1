...
class hanta(tk.Tk):
    ...
    def __init__(self, root):
        ...
        f_gd2 = Frame(self.root,bd=2,relief=RIDGE,bg="#4065a4")
        f_gd2.place(x=1024,y=630,width=340,height=120)
        Label(f_gd2,text="T_A",fg="white",bg="#4065a4",font=("times new roman",11,"bold"),bd=2).grid(row=0,column=1,padx=5,pady=10)        
        Entry(f_gd2,textvariable=self.tach,font=("times new roman",10),width=10,bd=2,relief=GROOVE).grid(row=1,column=1,padx=5,pady=10)
        Label(f_gd2,text="T_U",fg="white",bg="#4065a4",font=("times new roman",11,"bold"),bd=2).grid(row=0,column=2,padx=5,pady=10)
        Entry(f_gd2,textvariable=tu,font=("times new roman",10),width=10,bd=2,relief=GROOVE).grid(row=1,column=2,padx=5,pady=10)
        Label(f_gd2,text="T_R",fg="white",bg="#4065a4",font=("times new roman",11,"bold"),bd=2).grid(row=0,column=3,padx=5,pady=10)        
        Entry(f_gd2,textvariable=tr,font=("times new roman",10),width=10,bd=2,relief=GROOVE).grid(row=1,column=3,padx=5,pady=10)
        ...
        def get_cursor2(ev):
            cursor_row= self.pg.focus()
            contents= self.pg.item(cursor_row)
            row = contents['values']
            self.Id.set(row[0])
            self.tach.set(row[1])
            tu.set(row[2])
            tr.set(row[3])      
        self.pg.bind('<ButtonRelease-1>',get_cursor2)
        ...
        #f_gd2
        Button(f_gd2, text="continuer" , bg="black",fg="white",command=continuer).grid(row=0,column=4,padx=5,pady=10)
        Button(f_gd2, text="supprimer" , bg="black",fg="white",command=supp2).grid(row=1,column=4,padx=5,pady=10)  
        D_T()
