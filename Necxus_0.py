...
l1=Label(w,text='NOM DE COMPTE',bg='white')
l=("times new roman",13,"bold")
l1.config(font=l)
												...
												if DDN != '':
													if ((( DDN[6] != '1' and DDN[6] != '2') or (len(DDN) !=10)) or(DDN[2] != '/' or DDN[5] !='/')) :
														...
														if Contact != 0:
															if Genre != '':
																#========CDB=======
																conn = pymysql.connect(host="localhost",user="id17464992_bobi",password="bobi2003",database="id17464992_comimo")
																cur = conn.cursor()
																cur.execute(
...
def cmd2():
	...
	l1=Label(k,text='SAISIR UN NOM DE COMPTE',bg='white')
	l=("times new roman",13,"bold")
	l1.config(font=l)
	...
	def cmd3():
					...
					if e1.get()=='boby momo' and e2.get()=='bobi2003':
						...
						#========DTF=======
							...
							def affich_1(self):
								...
								for donnee in donnes:
									cur.execute(select,donnee)
								result = cur.fetchone()
				...
				def cmd2():
					...
					Button(k,width=45,height=2,bg='#994422',fg='white',text='Se Connecter',bd=0,command=cmd).place(x=90,y=540)
					k.mainloop()
				Button(w,width=45,height=2,bg='#994422',fg='white',text='Connecter',bd=0,command=cmd).place(x=90,y=540)
				Button(w,width=20,height=1,bg='#994422',fg='white',text='Creer un compte',bd=0,command=cmd2).place(x=180,y=590)
				
				w.mainloop()
	Button(k,width=45,height=2,bg='#994422',fg='white',text='Se Connecter',bd=0,command=cmd3).place(x=90,y=540)
	k.mainloop()
Button(w,width=45,height=2,bg='#994422',fg='white',text='Connecter',bd=0,command=cmd).place(x=90,y=540)
Button(w,width=20,height=1,bg='#994422',fg='white',text='Creer un compte',bd=0,command=cmd2).place(x=180,y=590)
